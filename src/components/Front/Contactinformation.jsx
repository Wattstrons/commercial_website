...
const ContactInformation = () => {
 ...
 borderRadius={24}
 animationSpeed={8}
 className="bg-[#0A0A0A] p-6 sm:p-8 lg:p-10 2xl:p-12 rounded-2xl"
 >
 ...
 {statusMessage.text && (
 <div className={`p-4 rounded-xl text-sm font-medium ${statusMessage.type === 'success' ? 'bg-[#00EDC2]/20 text-[#00EDC2] border border-[#00EDC2]/30' : 'bg-red-500/20 text-red-400 border border-red-500/30'}`}>
 {statusMessage.text}
 </div>
 )}
