...
const Ourprocess = ({
    ...
    return (
        <Section ref={sectionRef} className={className} style={{ position: "relative", height: `${(steps.length + 1) * 100}vh`, background: "#000", overflowX: "clip" }}>
            <Container style={{ position: "sticky", top: 0, height: "100vh", overflow: "hidden", display: "flex", paddingTop: 0 }}>
                ...
                <motion.div
                    ...
                    style={{ flex: "0 0 50%", position: "relative", overflow: "visible", zIndex: 0, display: "flex", alignItems: "flex-start", justifyContent: "center", paddingTop: "150px" }}
                >
                ...
                <motion.div
                    ...
                    viewport={{ once: true, margin: "150px" }}
                    transition={{ duration: 0.8, ease: "easeOut" }}
                    style={{ flex: "0 0 50%", position: "relative", display: "flex", alignItems: "flex-start", justifyContent: "flex-end", paddingLeft: "clamp(24px, 4vw, 64px)", zIndex: 10, paddingTop: "150px" }}
                >
