...
const Ourprocess = ({
 ...
 >
 <div className=" " style={{ width: "100%", height: "auto", maxWidth: 640, display: "flex", flexDirection: "column", gap: "10px", marginTop: "40px", maxHeight: "75vh", overflowY: "auto", paddingRight: "8px" }}>
