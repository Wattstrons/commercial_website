...
const Question = () => {
    ...
    return (
        <Section className="bg-transparent text-white relative z-10 !pt-6 lg:!pt-8 2xl:mt-[10px] !pb-0 md:!pb-0 lg:!pb-0">
 ...
 "
                                ...
                                >
                                    <ChevronDown className="w-5 h-5 sm:w-6 sm:h-6 lg:w-5 lg:h-5 xl:w-6 xl:h-6 " />
                                </span>
                            </div>
