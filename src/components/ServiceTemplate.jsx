    ...
    useEffect(() => {
        ...
        const handleGlobalMouseMove = (e) => {
            ...
            rafId = requestAnimationFrame(() => {
                mouseX.set(e.pageX - rectX);
                mouseY.set(e.pageY - rectY);
            });
        };
            ...
            <div
                ...
                style={{
                    ...
                    background: isHovered
                        ? "linear-gradient(135deg, rgba(255,255,255,0.35) 0%, rgba(255,255,255,0.2) 50%, rgba(255,255,255,0.3) 100%)"
                        ...
                        <div className="relative pt-0 pb-12 px-0">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center z-0 pointer-events-none">
                                ...
                                <div
                                    ...
                                    style={{ 
                                        background: "radial-gradient(circle, rgba(0,237,194,0.12) 0%, transparent 70%)",
                                ...
                                <div
                                    ...
                                    style={{ animation: "spinCW 20s linear infinite", willChange: "transform" }}
                                />
                                {/* Ring 2 */}
                                <div
                                    ...
                                    style={{ animation: "spinCCW 30s linear infinite", willChange: "transform" }}
                                />
                                {/* Ring 3 */}
                                <div
                                    className="absolute w-[500px] h-[500px] md:w-[700px] md:h-[700px] rounded-full border border-white/[0.02] border-l-[#00EDC2]/5"
                                    style={{ animation: "spinCW 45s linear infinite", willChange: "transform" }}
                                />
                                {/* Orbiting dot 1 */}
                                <div
                                    className="absolute w-[200px] h-[200px] md:w-[300px] md:h-[300px]"
                                    style={{ transformOrigin: "center", animation: "spinCW 12s linear infinite", willChange: "transform" }}
                                >
                                ...
                                <div
                                    ...
                                    style={{ transformOrigin: "center", animation: "spinCCW 18s linear infinite", willChange: "transform" }}
                                >
 ...
 "
            ...
            <div className="relative z-20 -mt-[100vh]">
                ...
                <div className="bg-black relative">
                    ...
                    {/* ── TECH STACK ─────────────────────────────────────────── */}
                    <Section className="bg-black !pt-0 relative overflow-hidden">
                        <Container>
                            <SectionHeader
                                            ...
                                            <div className="grid grid-cols-5 gap-2 opacity-60 group-hover:opacity-100 transition-opacity duration-500 w-full max-w-[85%] mt-2">
                                                {technologies.logos.slice(0, 10).map((tech, i) => (
                                                    <div key={i} className="aspect-square rounded-[6px] border border-white/5 flex items-center justify-center bg-white/5" style={{ boxShadow: "inset 0 0 10px rgba(255,255,255,0.02)" }}>
                                                        <img src={tech.logo} alt={tech.name} className="w-1/2 h-1/2 object-contain" decoding="async" loading="lazy" />
                                                    </div>
                                                ))}
                                ...
                                <div className="w-full mx-auto flex flex-wrap justify-center gap-4 relative z-10">
                                    {techStack.items.map((item, i) => (
                                        <div key={i} className="w-full md:w-[calc(50%-0.5rem)] lg:w-[calc(25%-0.75rem)] flex">
                                            <BentoCard className="min-h-[220px] w-full" innerClassName="p-6 flex flex-col justify-start group overflow-hidden">
                                                <div className="absolute inset-0 bg-[#0a0a0a] z-0" />
                                                <div className="relative z-10">
                                                    <h3 className="text-white font-bold text-lg mb-2 ">{item.title}</h3>
                                                    <p className="text-[14px] sm:text-[15px] lg:text-[16px] text-white/40 leading-relaxed ">{item.desc}</p>
                                                </div>
                                            </BentoCard>
                                        </div>
                                    ))}
                    ...
                    {/* ── TECHNOLOGIES GRID ─────────────────────────────────── */}
                    <Section noPadding className="bg-black !pt-0 relative overflow-hidden">
                        <Container>
                            <SectionHeader
                            ...
                            <div className="relative w-full mx-auto overflow-hidden flex flex-col gap-8 md:gap-12 pt-0 pb-0">
                                ...
                                >
                                    {[...technologies.logos, ...technologies.logos, ...technologies.logos, ...technologies.logos, ...technologies.logos, ...technologies.logos, ...technologies.logos, ...technologies.logos].map((tech, i) => (
                                        ...
                                        >
                                            ...
                                            >
                                                <img src={tech.logo} alt={tech.name} className="w-[60%] h-[60%] object-contain" decoding="async" loading="lazy" />
                                            </div>
                                        </div>
                                    ))}
                                </div>
                    ...
                    {/* ── OUR PROCESS ───────────────────────────────────────── */}
                    <Ourprocess title={process.header.title} subtitle={process.header.subtitle} steps={process.steps} className="!pt-4 md:!pt-8" />
