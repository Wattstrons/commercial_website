...
const SectionHeader = ({ 
 ...
 titleClassName = "font-bold tracking-tight leading-tight mb-3 text-white text-[clamp(28px,3.5vw,52px)]",
 subtitleClassName = "mt-0 mb-4 mx-auto text-white tracking-wide leading-relaxed text-[clamp(13px,1.2vw,18px)] max-w-[min(95vw,1200px)]",
 titleStyle = {},
 subtitleStyle = {}
}) => {
 return (
