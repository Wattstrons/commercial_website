...
const Careers = () => {
 ...
 className="max-w-5xl"
 >
 <h1 className="text-[clamp(1.6rem,5vw,4.5rem)] min-[1280px]:max-[1919px]:text-[clamp(3rem,4.5vw,4.5rem)] max-[359px]:!text-2xl leading-tight mb-6 text-white sm:whitespace-nowrap">
 Careers at Wattstrons
 </h1>

 <p className="text-gray-400 leading-relaxed mb-10 max-w-xl !text-[clamp(13px,1.2vw,18px)]">
